      ...
      <div className="flex flex-col rounded  shadow p-6">
        <form className='w-full' onSubmit={handleSubmit(submitHandler)} noValidate>
          ...
          <div className="pb-6">
            ...
            <div>
              <input id="name" type="text" className={`border ${errors.name ? 'border-2 border-red-100' : 'border-gray-400'} px-4 py-2 w-full`}
                {...register('name', {
                required: {
                  value: true,
          ...
          <div className="pb-4">
            ...
            <input id="email" type='email' className={`border ${errors.email ? 'border-2 border-red-100' : 'border-gray-400'} px-4 py-2 w-full`}
                   {...register('email', {
